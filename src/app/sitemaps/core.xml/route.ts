...
export function GET() {
  ...
  const xml = buildUrlset([
    ...
    { loc: `${BASE_URL}/sleep-time`,                          lastmod: now, changefreq: 'weekly',  priority: 0.8 },
    { loc: `${BASE_URL}/bedtime`,                             lastmod: now, changefreq: 'weekly',  priority: 0.8 },
    { loc: `${BASE_URL}/age`,                                 lastmod: now, changefreq: 'weekly',  priority: 0.8 },
    { loc: `${BASE_URL}/profession`,                          lastmod: now, changefreq: 'weekly',  priority: 0.8 },
    { loc: `${BASE_URL}/city`,                                lastmod: now, changefreq: 'weekly',  priority: 0.8 },
    { loc: `${BASE_URL}/baby-sleep-schedule`,                 lastmod: now, changefreq: 'weekly',  priority: 0.8 },
    { loc: `${BASE_URL}/sleep-with`,                          lastmod: now, changefreq: 'weekly',  priority: 0.8 },
