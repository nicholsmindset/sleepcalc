...
export async function generateMetadata({
  ...
  const entry = entries.find((e) => e.slug === slug && e.type === "bedtime");
...
export default async function BedtimePage({
  ...
  // Prev / next within bedtime entries (sorted by time)
  const bedtimeEntries = entries.filter((e) => e.type === "bedtime");
  const currentIdx = bedtimeEntries.findIndex((e) => e.slug === slug);
  const prevEntry = currentIdx > 0 ? bedtimeEntries[currentIdx - 1] : null;
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="text-left text-on-surface-variant/70 text-xs uppercase tracking-wider">
                      ...
                      <th className="pb-3 pr-4 font-medium">Wake Up</th>
              ...
              {prevEntry ? (
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-sm font-semibold text-on-surface truncate">Bed at {prevEntry.time}</p>
                  </div>
                </Link>
              ) : (
              ...
              {nextEntry ? (
                ...
                >
                  <div className="min-w-0 text-right">
                    ...
                    <p className="text-sm font-semibold text-on-surface truncate">Bed at {nextEntry.time}</p>
                  </div>
