...
const FOODS: Food[] = [
  ...
  { name: 'Avocado', emoji: '🥑', amount: '29 mg', serving: '100 g (1/2 fruit)', tryptophan: 13, magnesium: 29, melatonin: 0, b6: 0.26, calcium: 12, potassium: 485, sleepScore: 8 },
  ...
  // Calcium-rich
  { name: 'Greek yogurt', emoji: '🥛', amount: '200 mg', serving: '170 g (3/4 cup)', tryptophan: 95, magnesium: 19, melatonin: 0, b6: 0.08, calcium: 200, potassium: 240, sleepScore: 9 },
...
/* -------------------------------------------------------------------------- */
/*  Exported Tool Component                                                    */
/* -------------------------------------------------------------------------- */

export default function SleepFoodsTool() {
